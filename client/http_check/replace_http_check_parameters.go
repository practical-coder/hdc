...
func (o *ReplaceHTTPCheckParams) WithData(data *models.HTTPCheckRule) *ReplaceHTTPCheckParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the replace HTTP check params
func (o *ReplaceHTTPCheckParams) SetData(data *models.HTTPCheckRule) {
	o.Data = data
}
