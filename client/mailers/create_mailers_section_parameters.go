...
// NewCreateMailersSectionParamsWithTimeout creates a new CreateMailersSectionParams object
...
// NewCreateMailersSectionParamsWithContext creates a new CreateMailersSectionParams object
...
// NewCreateMailersSectionParamsWithHTTPClient creates a new CreateMailersSectionParams object
...
func (o *CreateMailersSectionParams) WithDefaults() *CreateMailersSectionParams {
	o.SetDefaults()
	return o
}
...
func (o *CreateMailersSectionParams) SetDefaults() {
	...
	val := CreateMailersSectionParams{
...
func (o *CreateMailersSectionParams) WithTimeout(timeout time.Duration) *CreateMailersSectionParams {
...
func (o *CreateMailersSectionParams) WithContext(ctx context.Context) *CreateMailersSectionParams {
	o.SetContext(ctx)
	return o
}
...
func (o *CreateMailersSectionParams) WithHTTPClient(client *http.Client) *CreateMailersSectionParams {
...
func (o *CreateMailersSectionParams) WithData(data *models.MailersSection) *CreateMailersSectionParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the create mailers section params
func (o *CreateMailersSectionParams) SetData(data *models.MailersSection) {
	o.Data = data
}
...
func (o *CreateMailersSectionParams) WithVersion(version *int64) *CreateMailersSectionParams {
...
func (o *CreateMailersSectionParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
