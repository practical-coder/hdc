...
// Code gets the status code for the get runtime server o k response
func (o *GetRuntimeServerOK) Code() int {
	return 200
}
...
// Code gets the status code for the get runtime server not found response
func (o *GetRuntimeServerNotFound) Code() int {
	return 404
}
