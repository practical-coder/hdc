...
// Code gets the status code for the get Tcp check o k response
func (o *GetTCPCheckOK) Code() int {
	return 200
}
...
// Code gets the status code for the get Tcp check not found response
func (o *GetTCPCheckNotFound) Code() int {
	return 404
}
