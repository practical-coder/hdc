...
// Code gets the status code for the get f c g i app o k response
func (o *GetFCGIAppOK) Code() int {
	return 200
}
...
// Code gets the status code for the get f c g i app not found response
func (o *GetFCGIAppNotFound) Code() int {
	return 404
}
