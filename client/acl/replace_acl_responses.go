...
// Code gets the status code for the replace Acl o k response
func (o *ReplaceACLOK) Code() int {
	return 200
}
...
// Code gets the status code for the replace Acl accepted response
func (o *ReplaceACLAccepted) Code() int {
	return 202
}
...
// Code gets the status code for the replace Acl bad request response
func (o *ReplaceACLBadRequest) Code() int {
	return 400
}
...
// Code gets the status code for the replace Acl not found response
func (o *ReplaceACLNotFound) Code() int {
	return 404
}
