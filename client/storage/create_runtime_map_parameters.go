...
/* CreateRuntimeMapParams contains all the parameters to send to the API endpoint
   for the create runtime map operation.
...
// WithDefaults hydrates default values in the create runtime map params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CreateRuntimeMapParams) WithDefaults() *CreateRuntimeMapParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the create runtime map params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CreateRuntimeMapParams) SetDefaults() {
