...
/* CreateRuntimeMapCreated describes a response with status code 201, with default header values.
...
/* CreateRuntimeMapBadRequest describes a response with status code 400, with default header values.
...
/* CreateRuntimeMapConflict describes a response with status code 409, with default header values.
...
/* CreateRuntimeMapDefault describes a response with status code -1, with default header values.
